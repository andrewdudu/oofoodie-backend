...
import com.oofoodie.backend.command.impl.CompleteOrderCommandImpl;
...
public class CompleteOrderCommandImplTest {

    @InjectMocks
    private CompleteOrderCommandImpl command;
    ...
    public void executeTest() {
        Orders orders = Orders.builder().status(StatusEnum.COMPLETED.toString()).build();
